...
-- Version: 2.1.0 (December 12, 2025 - Merged from multiple sources)
-- =================================================================
...
CREATE TABLE `bookmarks` (
  ...
  KEY `fk_bookmarks_property` (`property_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- User favorites (alternative to bookmarks)
...
CREATE TABLE `inquiries` (
  ...
  KEY `idx_status` (`status`),
  KEY `inquiries_responded_by_fk` (`responded_by`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `contact_messages` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_status` (`status`),
  KEY `fk_contact_responded_by` (`responded_by`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Saved Searches (for users to save their search criteria)
CREATE TABLE `saved_searches` (
  ...
  KEY `idx_active_searches` (`is_active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `property_price_history`
  ADD CONSTRAINT `fk_history_property` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_history_price` FOREIGN KEY (`price_id`) REFERENCES `prices` (`id`);
...
INSERT INTO `properties` (`propertiesname`, `slug`, `description`, `price_id`, `user_id`, `property_type_id`, `location_id`, `status`, `bedrooms`, `bathrooms`, `area_sqft`, `year_built`, `is_featured`, `views_count`, `created_at`, `updated_at`) VALUES
('Beautiful Family House', 'beautiful-family-house-new-york', 'Spacious 3-bedroom house with garden', 1, 2, 1, 1, 'available', 3, 2, 1800, 2015, 1, 6, '2025-09-21 05:33:31', '2025-09-22 23:25:06'),
('Modern Downtown Apartment', 'modern-downtown-apartment-la', 'Luxury apartment in city center', 2, 2, 2, 2, 'available', 2, 2, 1200, 2020, 1, 1, '2025-09-21 05:33:31', '2025-09-22 16:29:40'),
('Prime Land Plot', 'prime-land-plot-chicago', 'Perfect for development', 3, 2, 5, 3, 'available', 0, 0, 5000, NULL, 0, 5, '2025-09-21 05:33:31', '2025-09-22 16:29:15');
...
('JEFFREY EYRAM KWEKU AGRA', 'agrajeff15@gmail.com', '0598147331', 'Support', 'hello', 'new'),
('JEFFREY EYRAM KWEKU AGRA', 'agrajeff15@gmail.com', '0598147331', 'Support', 'hello', 'new'),
('JEFFREY EYRAM KWEKU AGRA', 'agrajeff1@gmail.com', '0598147331', 'Property Information', 'gdvdfffk', 'new');

-- Insert sample property views
INSERT INTO `property_views` (`property_id`, `user_id`, `ip_address`, `user_agent`) VALUES
(3, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
(3, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
(3, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
(3, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
(3, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
(2, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
(1, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
(1, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
(1, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
(1, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
(1, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36');
