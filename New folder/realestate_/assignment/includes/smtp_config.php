...
return [
    ...
    'smtp_username' => getenv('SMTP_USERNAME') ?: 'agrajeff15@gmail.com',
    'smtp_password' => getenv('SMTP_PASSWORD') ?: 'wlwcelgdueifokpm',
    'from_email' => getenv('FROM_EMAIL') ?: 'noreply@realestate.com',
    'from_name' => getenv('FROM_NAME') ?: 'RealEstate',
    'admin_email' => getenv('ADMIN_EMAIL') ?: 'agrajeff15@gmail.com',
    'smtp_secure' => getenv('SMTP_SECURE') ?: 'tls',
    'smtp_auth' => filter_var(getenv('SMTP_AUTH') ?: true, FILTER_VALIDATE_BOOLEAN),
